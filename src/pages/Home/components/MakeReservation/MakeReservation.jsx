...
export default function MakeReservation() {
  return (
    <div className="h-[80vh] bg-cover bg-bottom bg-no-repeat flex flex-col items-center justify-center space-y-20"
      ...
      <Link to='/reservation' className="px-6 py-2 border-2 border-white text-white rounded-full bg-transparent hover:bg-white hover:text-black transition-colors duration-300">
        Make a Reservation
      </Link>
    </div>
  );
